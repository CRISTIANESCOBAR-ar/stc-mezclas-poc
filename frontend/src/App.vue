      ...
      <nav class="flex flex-col items-center gap-1 w-full px-1.5">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <path d="M9 18h6"/>
            <path d="M10 22h4"/>
            <path d="M12 2a7 7 0 00-4 12.75c.75.5 1.25 1.25 1.4 2.1h5.2c.15-.85.65-1.6 1.4-2.1A7 7 0 0012 2z"/>
          </svg>
          <span class="pointer-events-none absolute left-full ml-3 whitespace-nowrap rounded-md bg-white border border-gray-200 shadow-md px-2 py-1 text-xs font-semibold text-gray-700 opacity-0 group-hover:opacity-100 transition-opacity z-50">
            Relato IA
          </span>
        ...
        <div class="relative w-full flex items-center justify-center px-1.5 h-10" ref="reportsAnchor">
          ...
          <!-- Dropdown Reportes -->
            ...
            >
              ...
              <router-link to="/meta-por-revisor" @click="reportsOpen = false" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
                <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 7h16M4 12h16M4 17h10"></path></svg>
                Meta por Revisor
              </router-link>
              ...
              <router-link to="/narrativa-costos" @click="reportsOpen = false" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-indigo-600 transition-colors">
...
const langOpen = ref(false);
  ...
  const reportRoutes = ['/resumen', '/resumen-cardas', '/matriz-control-uster', '/resumen-semanal-hilanderia', '/analisis-calidad-fibra', '/meta-por-revisor', '/informe-auditoria-lote', '/resumen-diario', '/dashboard-mezcla', '/stats'];
